...
| §80 | Serial / mini serial tuzilishi | `SeriesStructureAcceptanceTest` — ТЗ dagi daraxt to'liq quriladi |
| §80 | chuqur tekshiruv | `ContentStructureTest` |
| §81 | Reklama + CTR hisoboti | `AdvertisementModuleTest` (karusel tartibi ham), `AdAnalyticsTest`, `AdStatisticsEndpointTest` |
...
| 9 | Hardening — tests, performance, security, indexes | `[~]` 720 test; migratsiyalar V1–V26 |
