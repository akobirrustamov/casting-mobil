...
/**
 * Флаги рядом с названиями языков (заказчик, 15.09.2026: «tillar oldidan
 * bayroqlarni ham qo'y»).
 *
 * Эмодзи, а не картинки: рисует система, в сборку ничего не добавляется.
 * У английского — британский флаг: язык интерфейса, а не страна.
 */
