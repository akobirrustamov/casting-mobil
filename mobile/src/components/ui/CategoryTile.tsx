 ...
 *
 * <h2>⚠️ Сейчас её никто не рисует</h2>
 * Единственный ряд плиток стоял на главной («Yo'nalishlar»), и 14.09.2026
 * заказчик убрал его с экрана. Компонент оставлен целиком намеренно: ряд
 * возвращается одним блоком разметки (см. `app/(tabs)/index.tsx`), а тип
 * `CategoryGlyph` отсюда по-прежнему нужен `features/content/categoryIcons`.
 *
