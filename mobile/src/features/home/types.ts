...
export type ContentCard = {
   ...
   *
   * ⚠️ «Нравится» у карточки НЕТ намеренно. Карточка в ряду шириной
   * ~105px, и в нижнем углу кадра уже стоит длительность — второй
   * счётчик туда не влезает. Да и сердце — кнопка: нажимают его на
   * экране контента (`watch/StatChips`), где оно и живёт.
   */
