...
Осталось 5 и 6. Пока не сделано 5, флоу дойдёт до выбора аккаунта Google, приложение
получит `id_token`, а обмен упадёт с `503`. Пока не сделано 6 — APK не соберётся.
