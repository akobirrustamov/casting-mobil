...
function CastingUserDetail() {
    ...
    return (
        <div className="[font-family:Inter,-apple-system,BlinkMacSystemFont,Segoe_UI,Roboto,sans-serif] bg-[linear-gradient(135deg,#0f0f0f_0%,#000000_100%)] text-white min-h-screen">
            ...
            <div className="px-6 py-8 max-md:px-4 max-md:py-6 max-w-[1200px] mx-auto">
                <button className="inline-flex items-center bg-white/5 backdrop-blur-[10px] text-[#3b82f6] border border-white/10 rounded-xl px-5 py-3 mb-8 font-medium cursor-pointer transition-all duration-300 hover:bg-[rgba(59,130,246,0.1)] hover:-translate-x-[5px]" onClick={() => navigate(-1)}>
                ...
                {loading && !casting ? (
                    <div className="flex flex-col items-center justify-center h-[300px]">
                        ...
                        <p className="mt-4 text-[#a1a1aa] text-[1.1rem]">Yuklanmoqda...</p>
                    </div>
                ) : error ? (
                        ...
                        <div className="flex items-center mb-10 bg-white/[0.03] rounded-[20px] p-8 border border-white/10 max-md:flex-col max-md:text-center max-md:p-6">
                            ...
                            <div className="flex-1">
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-md text-[13px] cursor-pointer transition-all duration-300 hover:opacity-90 border-none text-white ${casting.isWebShow ? "bg-[#28a745]" : "bg-[#dc3545]"}`}
                                >
                                    {casting.isWebShow ? "Saytda Faol" : "Saytda Nofaol"}
                                </button>
                            </div>
                        </div>
                ...
                <Modal
                    ...
                    center
                    classNames={{
                        overlay: "!bg-black/60 !z-[9998]",
                        modal: "relative !z-[9999] m-auto !bg-[#1a1a1a] !text-white !rounded-xl !p-8 !max-w-[400px] !w-[90%]"
                    }}
                >
                ...
                <Modal
                    ...
                    classNames={{
                        overlay: "!bg-black/60 !z-[9998]",
                        modal: "relative !z-[9999] m-auto !bg-transparent !border-none !rounded-none !p-0 !max-w-[90vw] !w-auto"
                    }}
                >
                    ...
                    {selectedImage && (
                        <div className="relative inline-block">
                            ...
                            />
                            <button className="relative z-[10000] -top-[15px] -right-[15px] w-10 h-10 rounded-full bg-[#ef4444] text-white border-none flex items-center justify-center cursor-pointer text-[1.2rem] transition-all duration-300 hover:scale-110 hover:bg-[#dc2626]" onClick={closeImageModal}>
                                <FaTimes />
                            </button>
                        </div>
                    )}
                ...
                <Modal
                    ...
                    center
                    classNames={{
                        overlay: '!bg-black/85 backdrop-blur-[5px] !z-[9998]',
                        modal: 'relative !z-[9999] m-auto !bg-[#1a1a1a] !border !border-white/10 !rounded-[20px] !p-8 !max-w-[500px] !w-[90%]'
                    }}
                >
                    <div className="text-center">
                ...
                {confirmModal.show && (
                    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black/85 backdrop-blur-[5px] z-[9998]">
