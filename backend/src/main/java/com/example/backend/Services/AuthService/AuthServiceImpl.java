...
public class AuthServiceImpl implements AuthService {
    ...
    // ⚠️ sendOtp/verifyOtp va createPhoneUser BU YERDAN olib tashlandi
    // (04.09.2026). Telefon orqali kirish butunlay `AppAccountService`
    // ga ko'chdi: u yerda kod tekshiriladi, yangi odamdan ismi
    // so'raladi va hisob ISM BILAN birga yaratiladi.
    //
    // Bu yerdagi eski `createPhoneUser` esa ismsiz hisob yasardi —
    // profilda va izohlar ostida bo'shliq. Endi bunday satr paydo
    // bo'ladigan yo'l qolmadi.
