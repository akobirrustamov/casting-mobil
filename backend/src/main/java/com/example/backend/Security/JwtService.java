...
public class JwtService {
    ...
    void verifySecret() {
        ...
        throw new IllegalStateException(String.join("\n",
                ...
                "=========================================================",
                "",
                "  Kalit yasang (bir marta) va SAQLANG:",
                "",
                "      openssl rand -hex 32",
                "",
                "  Keyin quyidagilardan BIRINI qiling:",
                "",
                "  1) Muhit o'zgaruvchisi bilan:",
                "     APP_JWT_SECRET=<kalit> java -jar backend.jar",
                "",
                "  2) Tayyor skript bilan (sirlar faylini o'zi o'qiydi):",
                "     sh deploy/run.sh",
                "",
                "  3) Faqat lokal sinov uchun — kalit talab qilinmaydi:",
